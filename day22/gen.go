...
func main() {
	...
	moves := parts[1]
	moves = strings.Replace(moves, "L", ",L,", -1)
	moves = strings.Replace(moves, "R", ",R,", -1)
	fmt.Printf("var moves = []int{%v}", moves)
}
